...
const About: React.FC = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description: 'Având 21 de ani, a terminat liceul de muzica "Dinu Lipatti", fiind in prezent studentă la prestigioasa Universitate de Muzica din București pe secția de jazz vocal/instrumental. Poate adopta orice stil muzical, de la muzică ușoară la jazz, la muzică de petrecere și inclusiv instrumental pian.',
      image: '/silvia.jpg'
    },
    {
